...
public class Association12ResourceIT {
    ...
    public void createAssociation12() throws Exception {
        ...
        restAssociation12MockMvc.perform(post("/api/association-12-s").with(csrf())
    ...
    public void updateAssociation12() throws Exception {
        ...
        restAssociation12MockMvc.perform(put("/api/association-12-s").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteAssociation12() throws Exception {
        ...
        restAssociation12MockMvc.perform(delete("/api/association-12-s/{id}", association12.getId()).with(csrf())
