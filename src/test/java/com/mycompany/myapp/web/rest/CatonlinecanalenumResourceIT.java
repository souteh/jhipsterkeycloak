...
import com.mycompany.myapp.JhipsterkeycloakApp;
 ...
 */
@SpringBootTest(classes = { JhipsterkeycloakApp.class, TestSecurityConfiguration.class })
...
public class CatonlinecanalenumResourceIT {
    ...
    public void createCatonlinecanalenum() throws Exception {
        ...
        restCatonlinecanalenumMockMvc.perform(post("/api/catonlinecanalenums").with(csrf())
    ...
    public void updateCatonlinecanalenum() throws Exception {
        ...
        restCatonlinecanalenumMockMvc.perform(put("/api/catonlinecanalenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteCatonlinecanalenum() throws Exception {
        ...
        restCatonlinecanalenumMockMvc.perform(delete("/api/catonlinecanalenums/{id}", catonlinecanalenum.getId()).with(csrf())
