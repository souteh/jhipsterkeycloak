...
public class ClientglentityResourceIT {
    ...
    public void createClientglentity() throws Exception {
        ...
        restClientglentityMockMvc.perform(post("/api/clientglentities").with(csrf())
    ...
    public void updateClientglentity() throws Exception {
        ...
        restClientglentityMockMvc.perform(put("/api/clientglentities").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteClientglentity() throws Exception {
        ...
        restClientglentityMockMvc.perform(delete("/api/clientglentities/{id}", clientglentity.getId()).with(csrf())
