...
public class FormulationentityResourceIT {
    ...
    public void createFormulationentity() throws Exception {
        ...
        restFormulationentityMockMvc.perform(post("/api/formulationentities").with(csrf())
    ...
    public void updateFormulationentity() throws Exception {
        ...
        restFormulationentityMockMvc.perform(put("/api/formulationentities").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteFormulationentity() throws Exception {
        ...
        restFormulationentityMockMvc.perform(delete("/api/formulationentities/{id}", formulationentity.getId()).with(csrf())
