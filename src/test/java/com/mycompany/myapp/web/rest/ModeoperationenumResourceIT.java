...
public class ModeoperationenumResourceIT {
    ...
    public void createModeoperationenum() throws Exception {
        ...
        restModeoperationenumMockMvc.perform(post("/api/modeoperationenums").with(csrf())
    ...
    public void updateModeoperationenum() throws Exception {
        ...
        restModeoperationenumMockMvc.perform(put("/api/modeoperationenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteModeoperationenum() throws Exception {
        ...
        restModeoperationenumMockMvc.perform(delete("/api/modeoperationenums/{id}", modeoperationenum.getId()).with(csrf())
