...
public class PdventityResourceIT {
    ...
    public void createPdventity() throws Exception {
        ...
        restPdventityMockMvc.perform(post("/api/pdventities").with(csrf())
    ...
    public void updatePdventity() throws Exception {
        ...
        restPdventityMockMvc.perform(put("/api/pdventities").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deletePdventity() throws Exception {
        ...
        restPdventityMockMvc.perform(delete("/api/pdventities/{id}", pdventity.getId()).with(csrf())
