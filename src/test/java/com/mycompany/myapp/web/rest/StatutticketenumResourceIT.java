...
public class StatutticketenumResourceIT {
    ...
    public void createStatutticketenum() throws Exception {
        ...
        restStatutticketenumMockMvc.perform(post("/api/statutticketenums").with(csrf())
    ...
    public void updateStatutticketenum() throws Exception {
        ...
        restStatutticketenumMockMvc.perform(put("/api/statutticketenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteStatutticketenum() throws Exception {
        ...
        restStatutticketenumMockMvc.perform(delete("/api/statutticketenums/{id}", statutticketenum.getId()).with(csrf())
