...
public class TypeannulationenumResourceIT {
    ...
    public void createTypeannulationenum() throws Exception {
        ...
        restTypeannulationenumMockMvc.perform(post("/api/typeannulationenums").with(csrf())
    ...
    public void updateTypeannulationenum() throws Exception {
        ...
        restTypeannulationenumMockMvc.perform(put("/api/typeannulationenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTypeannulationenum() throws Exception {
        ...
        restTypeannulationenumMockMvc.perform(delete("/api/typeannulationenums/{id}", typeannulationenum.getId()).with(csrf())
