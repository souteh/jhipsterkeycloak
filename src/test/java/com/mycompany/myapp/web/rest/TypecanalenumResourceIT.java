...
public class TypecanalenumResourceIT {
    ...
    public void createTypecanalenum() throws Exception {
        ...
        restTypecanalenumMockMvc.perform(post("/api/typecanalenums").with(csrf())
    ...
    public void updateTypecanalenum() throws Exception {
        ...
        restTypecanalenumMockMvc.perform(put("/api/typecanalenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTypecanalenum() throws Exception {
        ...
        restTypecanalenumMockMvc.perform(delete("/api/typecanalenums/{id}", typecanalenum.getId()).with(csrf())
