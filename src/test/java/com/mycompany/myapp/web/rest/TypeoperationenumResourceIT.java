...
public class TypeoperationenumResourceIT {
    ...
    public void createTypeoperationenum() throws Exception {
        ...
        restTypeoperationenumMockMvc.perform(post("/api/typeoperationenums").with(csrf())
    ...
    public void updateTypeoperationenum() throws Exception {
        ...
        restTypeoperationenumMockMvc.perform(put("/api/typeoperationenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTypeoperationenum() throws Exception {
        ...
        restTypeoperationenumMockMvc.perform(delete("/api/typeoperationenums/{id}", typeoperationenum.getId()).with(csrf())
