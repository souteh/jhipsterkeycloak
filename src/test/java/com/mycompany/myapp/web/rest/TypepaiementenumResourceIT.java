...
public class TypepaiementenumResourceIT {
    ...
    public void createTypepaiementenum() throws Exception {
        ...
        restTypepaiementenumMockMvc.perform(post("/api/typepaiementenums").with(csrf())
    ...
    public void updateTypepaiementenum() throws Exception {
        ...
        restTypepaiementenumMockMvc.perform(put("/api/typepaiementenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTypepaiementenum() throws Exception {
        ...
        restTypepaiementenumMockMvc.perform(delete("/api/typepaiementenums/{id}", typepaiementenum.getId()).with(csrf())
