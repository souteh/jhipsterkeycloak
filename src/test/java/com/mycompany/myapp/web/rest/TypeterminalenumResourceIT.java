...
public class TypeterminalenumResourceIT {
    ...
    public void createTypeterminalenum() throws Exception {
        ...
        restTypeterminalenumMockMvc.perform(post("/api/typeterminalenums").with(csrf())
    ...
    public void updateTypeterminalenum() throws Exception {
        ...
        restTypeterminalenumMockMvc.perform(put("/api/typeterminalenums").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTypeterminalenum() throws Exception {
        ...
        restTypeterminalenumMockMvc.perform(delete("/api/typeterminalenums/{id}", typeterminalenum.getId()).with(csrf())
